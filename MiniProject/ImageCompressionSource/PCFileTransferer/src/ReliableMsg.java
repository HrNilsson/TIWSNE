 ...
 * This class implements a Java interface to the 'ReliableMsg'
 * message type.
 */

public class ReliableMsg extends net.tinyos.message.Message {
    ...
    /** Create a new ReliableMsg of size 1. */
    public ReliableMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new ReliableMsg of the given data_length. */
    public ReliableMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new ReliableMsg with the given data_length
     * and base offset.
     */
    public ReliableMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new ReliableMsg using the given byte array
     * as backing store.
     */
    public ReliableMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public ReliableMsg(byte[] data, int base_offset) {
     ...
     */
    public ReliableMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new ReliableMsg embedded in the given message
     * at the given base offset.
     */
    public ReliableMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public ReliableMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
